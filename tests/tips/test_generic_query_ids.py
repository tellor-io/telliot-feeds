...
async def test_collection_type_build_feed(autopay_contract_setup):
    ...
    metric = 1
    query_data = HexBytes(encode_abi(["string", "bytes"], [typ, encode_abi(["uint256", "address", "uint256"], [chain_id, contract_address, metric])]))
...
async def test_mashup_type_build_feed(autopay_contract_setup):
    ...
    metric = "market-cap"
    currency = "usd"
    collection = (('ethereum-mainnet', '0x50f5474724e0ee42d9a4e711ccfb275809fd6d4a'),
    ...
    tokens = (('ethereum-mainnet', 'sand', '0x3845badade8e6dff049820680d1f14bd3903a5d0'),
