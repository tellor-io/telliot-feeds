...
@pytest.mark.asyncio
async def test_wrseth_usd_median_feed(caplog):
    """Retrieve median WrsETH/USD price."""
    v, _ = await wrseth_usd_median_feed.source.fetch_new_datapoint()
    ...
    source_prices = wrseth_usd_median_feed.source.latest[0]
