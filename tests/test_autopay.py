...
async def test_main(
    ...
    async with TelliotCore(config=mumbai_test_cfg) as core:
        ...
        mock_token_contract.approve(
            mock_flex_contract.address, 50e18, {"from": core.get_account().address}
        )
        ...
        mock_token_contract.approve(
            mock_autopay_contract.address, 500e18, {"from": core.get_account().address}
        )
        ...
        read_timestamp, status = await autopay.read(
