...
class OsmosisPoolPriceService(WebPriceService):
    """Osmosis Price Service supporting stATOM/USD.

    Fetches current_sqrt_price from the Osmosis LCD REST API for the
    stATOM/ATOM concentrated liquidity pool (1283), squares it to get the
    stATOM/ATOM ratio, then multiplies by the ATOM/USD price from CoinGecko.
    """
