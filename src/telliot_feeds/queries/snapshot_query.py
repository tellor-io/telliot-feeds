...
class Snapshot(AbiQuery):
    ...
    def __init__(self, proposalId: str, transactionsHash: str, moduleAddress: str):
        self.proposalId = proposalId
        self.transactionsHash = bytes.fromhex(transactionsHash[2:])
        self.moduleAddress = moduleAddress

    #: ABI used for encoding/decoding parameters
    abi = [
        {"type": "string", "name": "proposalId"},
        {"type": "bytes32", "name": "transactionsHash"},
        {"type": "address", "name": "moduleAddress"},
    ]
