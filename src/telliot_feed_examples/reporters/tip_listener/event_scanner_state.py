...
class EventScannerState(ABC):
    ...
    @abstractmethod
    def start_chunk(self, block_number: int) -> Optional[int]:
    ...
    @abstractmethod
    def end_chunk(self, block_number: int) -> Optional[int]:
    ...
    def process_event(self, event: AttributeDict) -> object:
        ...
        This function takes raw events from Web3,
        transforms them to your application internal
